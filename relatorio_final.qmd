...
## Análise das 3 lojas com maior receita no ano de 1889 e dos 3 produtos mais vendidos em cada uma das lojas
  ...
  Além disso, foi observada a quantidade vendida de cada um dos produtos mais vendidos das três lojas com maior faturamento no ano de 1889. Para isso, foi utilizado um gráfico de colunas bivariado que permite observar cada um dos produtos separadamente.  
...
# Conclusões
  ...
  De forma geral, os resultados indicam um mercado em crescimento estável, com diferenças marcantes entre as lojas e padrões de consumo que podem orientar futuras estratégias comerciais e ajudam a compreender o comportamento do mercado e prever ideias futuras.  